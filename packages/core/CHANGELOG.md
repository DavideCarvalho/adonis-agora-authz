...
- [#92](https://github.com/DavideCarvalho/adonis-agora-authz/pull/92) [`517dd6b`](https://github.com/DavideCarvalho/adonis-agora-authz/commit/517dd6bd52875c093b501fec046daa9a1dcff826) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - Corrige o contrato documentado de `accessibleBy` e aceita o singleton do `services/main`.
...
- [#89](https://github.com/DavideCarvalho/adonis-agora-authz/pull/89) [`3c09458`](https://github.com/DavideCarvalho/adonis-agora-authz/commit/3c094580f3b7fea80cfcacab8b943b464469a1d2) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - **The service singleton is the way in.** `import authz from '@adonis-agora/authz/services/main'`
...
- [#86](https://github.com/DavideCarvalho/adonis-agora-authz/pull/86) [`88dc9e5`](https://github.com/DavideCarvalho/adonis-agora-authz/commit/88dc9e5eb38260aa43b0360b23624f11262c85d5) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - **`authzRolesRelation()` now works with any host key — integer, bigint or uuid, on any table, with
  ...
  no error ([#74](https://github.com/DavideCarvalho/adonis-agora-authz/issues/74)). The relation now normalizes both on its first query: it points `localKey` at a
...
- [#53](https://github.com/DavideCarvalho/adonis-agora-authz/pull/53) [`2d8b021`](https://github.com/DavideCarvalho/adonis-agora-authz/commit/2d8b02107b2289f8496d54f8f41d3452e59a96db) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - `node ace add @adonis-agora/authz` quebrava logo depois de instalar, com
...
- [#49](https://github.com/DavideCarvalho/adonis-agora-authz/pull/49) [`73f246a`](https://github.com/DavideCarvalho/adonis-agora-authz/commit/73f246ae92a7f6f1a61d02451093a8e69c10b9a7) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - Novo `authzRolesRelation()`: as opções de um `manyToMany` do Lucid ligando o modelo de
...
- [#47](https://github.com/DavideCarvalho/adonis-agora-authz/pull/47) [`773800f`](https://github.com/DavideCarvalho/adonis-agora-authz/commit/773800fb4b250a41d969e69081bbded944f7c8ae) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - `authorizeByRoles` gains `loginPath`: send an expired session to your login page instead of a
  dead end.
...
- [`faa95ca`](https://github.com/DavideCarvalho/adonis-agora-authz/commit/faa95cafcb7710eb39afd1141572ba132c9c45ef) - Add `authorizeByRoles({ roles, scope? })` — a factory for dashboard `authorize` hooks.
...
- [`ff38ee0`](https://github.com/DavideCarvalho/adonis-agora-authz/commit/ff38ee0a3d4ea5e2c763173d96cf9f269b110ee8) - `DiagnosticEvent` passa a descrever o payload que o authkit REALMENTE publica
...
- [#34](https://github.com/DavideCarvalho/adonis-agora-authz/pull/34) [`b55a532`](https://github.com/DavideCarvalho/adonis-agora-authz/commit/b55a5324fd9126b2700f763d75af55b505c15c90) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - Fix the `@adonis-agora/diagnostics` peer range, which was unsatisfiable by every
